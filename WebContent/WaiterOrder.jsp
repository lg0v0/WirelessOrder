...
<html lang="en">
  ...
  <body class=""> 
    <script charset="UTF-8" type="text/javascript" src="js/WaiterOrder.js"></script>
        <div class="navbar">
        <div class="navbar-inner">
                ...
                <center style="margin-top:10px;"><span style="color:#ccc;">桌号：<span id="tablenum"><%=session.getAttribute("tablenum")%></span></span></center>
        </div>
    </div>
...
<div class="content">
    ...
    <div>
    	<center><button class="btn btn-default" id="submit">提交</button></center>
    </div>
</div>  
			<footer>
			<hr>
